...
const PRESET_THEMES = [
  { id: 'arlan-espresso', name: 'Deep Espresso', color1: '#2d2424', color2: '#2d2424', textColor: '#f7f1e5', accentColor: '#e0c097' },
  { id: 'arlan-willow', name: 'Willow Green', color1: '#a7ad91', color2: '#a7ad91', textColor: '#2d2424', accentColor: '#d1a28a' },
  { id: 'arlan-sand', name: 'Desert Sand', color1: '#d1a28a', color2: '#d1a28a', textColor: '#2d2424', accentColor: '#f7f1e5' },
  { id: 'arlan-linen', name: 'Warm Linen', color1: '#f7f1e5', color2: '#e0c097', textColor: '#2d2424', accentColor: '#8c7a6b' },
  { id: 'arlan-grad', name: 'Truffle & Hazelnut', color1: '#b4a7a0', color2: '#8c7a6b', textColor: '#ffffff', accentColor: '#2d2424' }
];

const MS_LOGOS = [
  { id: 'none', label: 'Sin Logo', src: '' },
  { id: 'arlan-main', label: 'Logo ARLAN', src: '/recursos/ARLAN_full_logo_1.svg' }
];

const MS_BACKGROUNDS = [
  { id: 'none', label: 'Sin Fondo (Color)', src: '' },
  { id: 'fondo1', label: 'Ambiente 1', src: '/recursos/fondo_1.jpg' },
  { id: 'fondo2', label: 'Ambiente 2', src: '/recursos/fondo_2.jpg' },
  { id: 'fondo3', label: 'Ambiente 3', src: '/recursos/fondo_3.jpg' },
  { id: 'fondo4', label: 'Ambiente 4', src: '/recursos/fondo_4.jpg' },
  { id: 'fondo5', label: 'Ambiente 5', src: '/recursos/fondo_5.jpg' },
  { id: 'fondo6', label: 'Ambiente 6', src: '/recursos/fondo_6.jpg' },
  { id: 'fondo7', label: 'Ambiente 7', src: '/recursos/fondo_7.jpg' },
  { id: 'fondo8', label: 'Ambiente 8', src: '/recursos/fondo_8.jpg' }
];
...
export default function App() {
  ...
  const [content, setContent] = useState({
    title: 'Celebra con Elegancia y Diseño',
    description: 'Transformamos tus eventos en experiencias memorables con nuestro mobiliario de alta calidad.',
    logo: MS_LOGOS[1].src,
    signature: ''
  });
  ...
  const [activeLogoId, setActiveLogoId] = useState('arlan-main');
  ...
  const handleAIGenerate = async () => {
    const topic = window.prompt("🤖 Redactor AI de ARLAN Celebrations\nDescribe brevemente de qué tratará la publicación (ej: Nuevo catálogo de mobiliario, Inspiración de boda, etc.)");
    if (!topic) return;
  ...
  const handleExport = async () => {
    if (contentRef.current) {
      try {
        ...
        link.download = `ARLAN_${activeNetwork.name}_${activeFormat.name}.png`;
        link.href = dataUrl;
        link.click();
      } catch (err) {
      ...
      <header className="app-header">
        ...
        <div style={{display: 'flex', alignItems: 'center', gap: '16px'}}>
          ...
          >
             ...
             {isGenerating ? 'Generando ARLAN Post...' : 'Redactor IA Mágico'}
          </button>
        ...
        <aside className="sidebar" style={{width: '340px'}}>
          ...
          <div className="sidebar-section">
            ...
            <div className="editor-panel" style={{marginTop: 0, display: 'flex', flexDirection: 'column', gap: '16px'}}>
              ...
              <div className="input-group" style={{marginBottom: 0}}>
                <label className="input-label">Logo ARLAN</label>
                <select 
                  className="form-control"
                  value={activeLogoId}
                  onChange={(e) => {
